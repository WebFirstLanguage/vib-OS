/*
 * vib-OS CRC32 Implementation
 *
 * Standard CRC32 algorithm (IEEE 802.3 polynomial: 0xEDB88320)
 */
 ...
 * @crc: Initial CRC value (use 0 for first block)
 * @buf: Data buffer
 * @len: Length of data
 *
